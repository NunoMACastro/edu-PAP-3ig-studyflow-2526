...
## Contexto do BK
- Entrega alvo: `O aluno inscrito numa turma recebe versão limitada da IA.` com rastreabilidade direta para `RF23`.
...
- [ ] Sei explicar como `RF23` se traduz em comportamento implementável.
