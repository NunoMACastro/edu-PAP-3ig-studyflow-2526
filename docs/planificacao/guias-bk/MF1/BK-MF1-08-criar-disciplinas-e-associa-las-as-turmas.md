...
## Contexto do BK
- Entrega alvo: `Criar disciplinas e associá-las às turmas.` com rastreabilidade direta para `RF20`.
...
- [ ] Sei explicar como `RF20` se traduz em comportamento implementável.
...
### Passos
1. Confirmar no backlog e na matriz o escopo de `BK-MF1-08` e do requisito `RF20`.
...
export function autorizarContexto(c: Contexto) {
  ...
  return { bkId: 'BK-MF1-08', req: 'RF20', autorizado: true };
}
```

Evita operações docentes fora do contexto da turma/disciplina.
- Requisitos alvo deste BK: `RF20`.
