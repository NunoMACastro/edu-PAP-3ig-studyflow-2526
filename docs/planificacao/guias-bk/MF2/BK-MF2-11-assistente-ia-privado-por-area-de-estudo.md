...
## Contexto do BK
- Entrega alvo: `Assistente IA privado por Área de Estudo.` com rastreabilidade direta para `RF35`.
...
- Confirmar dependencias: `BK-MF0-10`.
...
- [ ] Sei explicar como `RF35` se traduz em comportamento implementável.
...
### Passos
1. Confirmar no backlog e na matriz o escopo de `BK-MF2-11` e do requisito `RF35`.
2. Validar pre-condicoes técnicas e dependencias declaradas: `BK-MF0-10`.
...
export function responderIA(perfil: 'ALUNO' | 'TURMA' | 'PROFESSOR', pergunta: string, fontes: Fonte[]) {
  ...
  return { bkId: 'BK-MF2-11', req: 'RF35', perfil, resposta: 'Gerada com base documental', fontes };
}
```

Força citação de fonte e aplica perfil de guardrail por contexto.
- Requisitos alvo deste BK: `RF35`.
