...
- [ ] Sei apontar o requisito `RF55` e demostrar cobertura objetiva.
...
2. Validar pre-condicoes tecnicas e dependencias declaradas: `BK-MF0-04`.
...
export function exigirSessao(u: UtilizadorSessao | null, papelNecessario: UtilizadorSessao['papel']) {
  ...
  return { ok: true, bk: 'BK-MF4-07', req: 'RF55' };
}
```
