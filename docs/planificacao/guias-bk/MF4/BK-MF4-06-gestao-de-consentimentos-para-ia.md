...
## Contexto do BK
- Entrega alvo: `Gestão de consentimentos para IA.` com rastreabilidade direta para `RF54`.
...
- [ ] Sei explicar como `RF54` se traduz em comportamento implementável.
...
### Passos
1. Confirmar no backlog e na matriz o escopo de `BK-MF4-06` e do requisito `RF54`.
...
export function registarConsentimento(c: Consentimento) {
  ...
  return { bkId: 'BK-MF4-06', req: 'RF54', evento: 'CONSENTIMENTO_REGISTADO', consentimento: c };
}
```

Cria trilho auditável obrigatório para RGPD.
- Requisitos alvo deste BK: `RF54`.
