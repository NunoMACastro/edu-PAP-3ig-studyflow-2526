...
- [ ] Sei apontar o requisito `RF43` e demostrar cobertura objetiva.
...
2. Validar pre-condicoes tecnicas e dependencias declaradas: `BK-MF3-05`.
...
export function exigirSessao(u: UtilizadorSessao | null, papelNecessario: UtilizadorSessao['papel']) {
  ...
  return { ok: true, bk: 'BK-MF3-07', req: 'RF43' };
}
```
