...
- [ ] Sei apontar o requisito `RF48` e demostrar cobertura objetiva.
...
2. Validar pre-condicoes tecnicas e dependencias declaradas: `BK-MF0-05`.
...
export function exigirSessao(u: UtilizadorSessao | null, papelNecessario: UtilizadorSessao['papel']) {
  ...
  return { ok: true, bk: 'BK-MF3-12', req: 'RF48' };
}
```
