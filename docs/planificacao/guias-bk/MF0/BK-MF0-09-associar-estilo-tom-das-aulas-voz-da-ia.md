...
## Contexto do BK
- Entrega alvo: `Associar estilo/tom das aulas → “voz” da IA.` com rastreabilidade direta para `RF09`.
...
- [ ] Sei apontar o requisito `RF09` e demostrar cobertura objetiva.
...
### Passos
1. Confirmar no backlog e na matriz o escopo de `BK-MF0-09` e do requisito `RF09`.
2. Validar pre-condicoes tecnicas e dependencias declaradas: `BK-MF0-07`.
...
export function exigirSessao(u: UtilizadorSessao | null, papelNecessario: UtilizadorSessao['papel']) {
  ...
  return { ok: true, bk: 'BK-MF0-09', req: 'RF09' };
}
```
